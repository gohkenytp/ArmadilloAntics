...
import gohkenytp.armadilloantics.core.registry.ArmadilloAnticsBiomeModifierTypes;
...
public class ArmadilloAntics {
    ...
    public ArmadilloAntics() {
        ...
        ArmadilloAnticsBiomeModifierTypes.BIOME_MODIFIER_SERIALIZERS.register(bus);
