...
public class Armadillo extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, Skeleton.class, 8.0F, 1.0D, 1.0D));
        this.goalSelector.addGoal(9, new TemptGoal(this, 1.0D, Ingredient.of(ArmadilloAnticsItemTags.ARMADILLO_FOOD), false));
    }
